  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        <h2 class="w3-opacity" align="center">ข้อมูลการรับคืนอุปกรณ์ทั้งหมด</h2>
        <h4></h4><br>
        <hr class="w3-clear">
              <table width="100%" >
                    <thead>
                      <tr align="center">
                        <th width="30%">เลขที่เอกสาร</th>
                        <th width="30%">ชื่อผู้ทำรายการ</th>
                        <th width="15%">วันที่รับคืน</th>
                        <th width="15%" colspan="3">Tool</th>
                      </tr>
                      </thead>
                    </div>
                      <?php 
                      $sql_Si="Select * from Account_tb,receive_tb where Account_tb.ACC_ID = receive_tb.ACC_ID group by receive_tb.Rec_No ORDER BY receive_tb.Rec_ID DESC";
                      $query_Si=mysqli_query($conn,$sql_Si);
                      while ($data_Si=mysqli_fetch_array($query_Si))                       
                      { 
                      $Rec_No = $data_Si["Rec_No"];
                      $Rec_Date = $data_Si["Rec_Date"];
                      $Rec_Unit = $data_Si["Rec_Unit"];
                    ...
                    <tbody>
                      <tr >                      
                        <td align="left" ><?php echo  $Rec_No; ?></td>
                        <td align="center" ><?php echo $Acc_Name;?></td>
                        <td align="center" ><?php echo $Rec_Date;?></td>
                        <form action="Management_Report_Receive.php" method="POST">
                        <input type="text" hidden  id="Receive_No" name="Receive_No" value="<?php echo $Rec_No ?>"></p>
                        <td align="center" >
