<div class="w3-card w3-round">
        <div class="w3-white">
          <button onclick="myFunction('Demo1')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-plus-square-o fa-fw w3-margin-right"></i> Project</button>
          <div id="Demo1" class="w3-hide w3-container">

            <form action="Management-Create-Project.php" method="POST">
          ...
          <button onclick="myFunction('Demo2')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-plus-square-o fa-fw w3-margin-right"></i> เบิกอุปกรณ์</button>
              <div id="Demo2" class="w3-hide w3-container">
                <form action="Management-Create-Withdraw.php" method="POST">
