              ...
              <table width="100%" >
                    <thead>
                      <tr align="center">
                        ...
                        <th width="15%">SLA/ชั่วโมง</th>
                        <th width="15%">ประเภท</th>
                        <th width="15%">รายการ</th>
                        <th width="15%" colspan="4">Tool</th>
                      </tr>
                      </thead>
                    </div>
                      <?php 
                      $sql_Si="Select * from `call-project_tb` ORDER BY Project_ID DESC";
                      ...
                      $Project_SLAX = $data_Si["Project_SLA"];
                      $Project_Type_SLAX = $data_Si["Project_Type_SLA"];

                      if($Project_Type_SLAX == "ํYes"){$Project_Type_SLAX ="รวมวันหยุด";}
                      if($Project_Type_SLAX == "No"){$Project_Type_SLAX ="ไม่รวมวันหยุด";}

                      $sql_Count="Select * from `Call-Device_tb` where Project_ID = '$Project_IDX'";
                    ...
                    <tbody>
                      <tr >                      
                        ...
                        <td align="center" ><?php echo $Project_SLAX;?></td>
                        <td align="center" ><?php echo $Project_Type_SLAX;?></td>
                        ...
                        <form action="Management-Call-Site.php" method="POST">
                        <input type="text"   id="Project_IDX" hidden name="Project_IDX" value="<?php echo $Project_IDX ?>"></p>
                        <td align="center" >
                          <button <?php if($Acc_NameX=="Admin-System"){ ?> hidden <?php } ?> class="btn" name="Select"><i class="fa fa-map-marker" ></i></button>
                        </td>
                        </form>
                        ...
                        <form action="Management-Call-Screen.php" method="POST">
