...
$result_Pro=mysqli_query($conn, "SELECT * FROM brand_tb,type_tb,Project_tb,Device_tb WHERE  
brand_tb.Brand_ID = Device_tb.Brand_ID and
type_tb.Type_ID = Device_tb.Type_ID and
Project_tb.Project_ID = Device_tb.Project_ID and Device_tb.Dev_ID='$Dev_ID'")or die('Error In Session');
