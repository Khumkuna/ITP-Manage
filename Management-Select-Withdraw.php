...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <p>
      <h4 class="w3-opacity" align="center">ข้อมูลโครงการ </h4></p>
                            ...
                            { 
                              ...
                              $Dev_Model = $data_GetPro['Dev_Model'];
                                ...
                                <table width="100%">
                                        ...
                                        <?php
                                        $sql_GetSerial="Select * from serial_tb where Dev_ID ='$Dev_ID'";
                                        ...
                                        { 
                                          ...
                                          ?>
                                              ...
                                              <tr>
                                                <td align="left"><input type="checkbox" <?php if($Total <= 0){?> disabled <?php } ?>  name="Ser_ID[]" value="<?php echo $Ser_ID ?>">
                                                </td>
